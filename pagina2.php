...
<body>
    <div class="header">
        <p><strong>Multifólio</strong></p> 

        <div class="search-container">
    <input type="text" id="search-input" placeholder="Buscar área">
    ...
    <script src="script.js"></script>
        ...
        <div class="cadastro">
<a href="./candidato/cadport.php">  Ver perfil</a></input>
</div>
...
<div class="menu">
<div class="filters">
    <strong><h3>FILTROS</h3></strong>
    <div class="formaT">
    <label>Por Forma de Trabalho:</label><br>
